...
class PangramString {
    ...
    public static boolean allLetter2(String str) {
    ...
    public static void main(String args[]) {
        ...
        String str2 = "Abcdefghijk**&lmnopqrstuvwxyz12";
...
The idea is to convert the given string into lower case alphabets and then iterate over each character from a to z itself and check if the given string contains all the letters from a to z. 
If all the letters are present then print Yes, otherwise print No.
